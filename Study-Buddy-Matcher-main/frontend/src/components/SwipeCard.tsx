...
export default function SwipeCard({
  ...
  return (
    <div className="relative w-full max-w-md mx-auto min-h-[min(550px,calc(100dvh-220px))]" id={`swipe-card-wrapper-${buddy.id}`}>
      <AnimatePresence mode="wait">
        {!swipeDirection && (
          <motion.div
            ...
            className="w-full min-h-[min(550px,calc(100dvh-220px))] bg-white border border-slate-100 rounded-3xl p-4 sm:p-6 flex flex-col justify-between hover:shadow-sm transition-shadow duration-200 relative"
          >
