...
export default function StudyPodsPanel({
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }} className="grid grid-cols-1 gap-8 text-xs lg:grid-cols-12" id="pods-panel-container">
      {/* Left Pane - Listing / Creator */}
      <div className="lg:col-span-5 space-y-6" id="pods-left-pane">
        
        {/* Create a Study Pod Panel Trigger */}
        <div className="rounded-[1.5rem] border border-slate-100 bg-white p-6 shadow-sm" id="pods-creator-trigger-card">
          {!isCreating ? (
            <div className="flex items-center justify-between" id="pods-trigger-inactive">
              ...
              <button
                ...
                className="flex shrink-0 items-center justify-center gap-1 rounded-xl bg-fuchsia-500 p-3 font-bold text-white transition-colors hover:bg-fuchsia-600"
        ...
        {/* My Joined Pods */}
        <div className="rounded-[1.5rem] border border-slate-100 bg-white p-6 shadow-sm" id="my-joined-pods-card">
          ...
          {myJoinedPods.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-violet-200 bg-[#faf8ff] py-9 text-center" id="empty-my-pods">
              <Users className="mx-auto mb-3 h-9 w-9 text-violet-300" />
              <p className="text-sm font-semibold text-slate-700">Your study circle starts here</p>
      ...
      <div className="lg:col-span-7 space-y-6" id="pods-right-pane">
        ...
        {activePod ? (
          <div className="space-y-6 rounded-[1.5rem] border border-slate-100 bg-white p-6 shadow-sm" id="selected-pod-details-card">
              ...
              {podSessions.length === 0 ? (
                <div className="text-center py-6 bg-slate-50/50 rounded-2xl border border-dashed border-slate-200" id="empty-pod-sessions">
                  ...
                  <button
                    type="button"
                    onClick={() => onScheduleForPod(activePod)}
                    className="mt-3 rounded-xl bg-fuchsia-500 px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-white transition-colors hover:bg-fuchsia-600"
                  >
          ...
          <div className="rounded-[1.5rem] border border-slate-100 bg-white p-6 shadow-sm" id="pods-browser-card">
