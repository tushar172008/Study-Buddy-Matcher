...
export default function DataImportWidget({ onImportStudents, existingCount }: DataImportWidgetProps) {
  ...
  return (
    <div className="space-y-6 rounded-[1.5rem] border border-slate-100 bg-white p-5 shadow-sm sm:p-6 md:p-8" id="data-import-container">
      <div className="border-b border-slate-100 pb-4" id="import-header">
        <h3 className="text-sm font-bold uppercase tracking-wider text-slate-950 flex items-center gap-2">
          <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-violet-50 text-violet-600"><Upload className="w-4 h-4" /></span>
